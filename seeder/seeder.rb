...
pages << {
    ...
    method: 'POST',
    page_type: 'categories',
    body: '{"operationName":"categoryChildren","variables":{},"extensions":{"persistedQuery":{"version":1,"sha256Hash":"b4392e9f79e8312d6fe57b47807d01d23a7e609defea9b796ab1b83ba78d6496","sender":"discoargentina.store-theme@4.x","provider":"vtex.catalog-graphql@1.x"},"variables":"eyJpZCI6IjEifQ=="}}',
    headers: {
        'Accept' => '*/*',
        'Accept-Encoding' => 'gzip, deflate, br',
        'Accept-Language' => 'en-US,en;q=0.9',
